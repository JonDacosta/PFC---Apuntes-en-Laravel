...
@section ('content')
    ...
    <h2 class="text-center mb-5">Crear nuevo Apunte</h2>

    
    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
            <form method="POST" action="{{ route('apuntes.store') }}" enctype="multipart/form-data" novalidate>
                @csrf
                ...
                <div class="form-group mt-3">
                    ...
                    <input id="notas" type="hidden" name="notas" value="{{ old('notas') }}">
                    <trix-editor
